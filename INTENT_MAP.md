...
## Legenda typů stránek

| Typ | Popis | Cíl |
|-----|-------|-----|
| **Form** | Formulář / generátor smlouvy | Transakční — vyplnění a zakoupení dokumentu |
| **Landing** | Informační stránka k typu smlouvy | Informační — zachytit broad search, konvertovat na Form |
| **Article** | Blogový průvodce | SEO — hloubkový obsah, konvertovat na Landing nebo Form |
| **Hub** | Homepage nebo blog index | Navigační — rozcestník pro další stránky |

---

## 🔵 Generator (Form) stránky — 14 URL

| URL | Hlavní keyword | Sekundární keyword | Canonical | Guide link | Blog článek |
|-----|----------------|--------------------|-----------|------------|-------------|
...
## 🟡 SEO Landing stránky — 14 URL

| URL | Hlavní keyword | Sekundární keyword | Canonical | Odkazuje na Form | Odkazuje na Článek |
|-----|----------------|--------------------|-----------|------------------|--------------------|
| `/najemni-smlouva` | nájemní smlouva vzor | nájemní smlouva 2026 | self | `/najem` ✅ | `/blog/najemni-smlouva-vzor-2026` ✅ |
| `/najemni-smlouva-byt` | nájemní smlouva byt | nájemní smlouva na byt 2026 | self | `/najem` (ověřit) | — |
| `/kupni-smlouva` | kupní smlouva vzor | kupní smlouva online | self | `/kupni` ✅, `/auto` ✅ | — |
| `/darovaci-smlouva` | darovací smlouva vzor | darovací smlouva 2026 | self | `/darovaci` (ověřit) | — |
| `/smlouva-o-dilo-online` | smlouva o dílo online | smlouva o dílo vzor | self | `/smlouva-o-dilo` ✅ | — |
| `/pracovni-smlouva` | pracovní smlouva vzor | pracovní smlouva 2026 | self | `/pracovni` (ověřit) | — |
| `/dohoda-o-provedeni-prace` | DPP vzor | dohoda o provedení práce | self | `/dpp` (ověřit) | — |
| `/nda-smlouva` | NDA smlouva | smlouva o mlčenlivosti vzor | self | `/nda` (ověřit) | — |
| `/pujcka-smlouva` | smlouva o půjčce | smlouva o zápůjčce vzor | self | `/pujcka` (ověřit) | — |
| `/podnajemni-smlouva` | podnájemní smlouva vzor | podnájem bytu 2026 | self | `/podnajem` (ověřit) | — |
| `/plna-moc-online` | plná moc vzor | plná moc online 2026 | self | `/plna-moc` (ověřit) | — |
| `/uznani-dluhu-vzor` | uznání dluhu vzor | uznání dluhu 2026 | self | `/uznani-dluhu` (ověřit) | — |
| `/smlouva-o-sluzbach` | smlouva o poskytování služeb | freelancer smlouva | self | `/sluzby` (ověřit) | — |
| `/smlouva-o-spolupraci` | smlouva o spolupráci vzor | smlouva o spolupráci OSVČ | self | `/spoluprace` (ověřit) | — |
...
|-----|------|----------------|------------------|--------------|
| `/blog/najemni-smlouva-vzor-2026` | Průvodce nájemní smlouvou | nájemní smlouva vzor | `/najem` ✅ | `/najemni-smlouva` ✅ |
| `/blog/kupni-smlouva-na-auto-2026` | Průvodce kupní smlouvou na auto | kupní smlouva auto | `/auto` ✅ | `/kupni-smlouva` (partial) |
...
## 📊 Stav content clusterů — přehled

| Typ smlouvy | Form | Landing | Článek | Cluster stav |
|-------------|------|---------|--------|--------------|
...
1. **Ověřit interní linking** na landing stránkách označených "(ověřit)" — zda skutečně odkazují na svůj Form
2. **Napsat chybějící blog články** dle priority tabulky výše
3. **Dodat `/auto` vlastní landing page** — `/kupni-smlouva-auto` nebo rozšířit `/kupni-smlouva` o sekci pro auto
4. **Konsolidovat `/najemni-smlouva-byt`** — buď přesměrovat na `/najemni-smlouva`, nebo dát každé stránce jiný intent

---

## Pravidla pro nové URL

- Generator (Form): `/[kratky-nazev]` — transakcionalní title, formulářová keywords
- Landing (Info): `/[nazev-smlouvy]-[rok-nebo-variant]` — informační title, broad keywords
- Blog (Průvodce): `/blog/[nazev-smlouvy]-[rok]` — long-tail keywords, edukační obsah
- Canonical vždy = sám na sebe (žádné cross-canonicaly mezi páry)
- Form → Landing: via `guideHref` prop v ContractLandingSection
- Landing → Form: via primární CTA tlačítko
- Blog → Form: via ArticleInlineCta + ArticleTrustBox
