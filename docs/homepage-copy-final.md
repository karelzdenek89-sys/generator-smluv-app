# SmlouvaHned.cz — Homepage copy · produkční verze v3
*Finální verze připravená k nasazení — 2026-04-03*

Změny v3 oproti v2: H1 „správně" → „systematicky"; subheadline „kde nepotřebujete advokáta" → „které nevyžadují individuální právní řešení" (sjednoceno napříč stránkou); sekce srovnání zkrácena o ~20 % (3 → 2 body na sloupec, závěrečná věta přeformulována); echo staré formulace opraveno v závěrečném CTA.
...
**H1:**
Sestavte smlouvu systematicky.
Bez opisování šablon, bez improvizace.

**Subheadline:**
SmlouvaHned je online nástroj, který z vašich údajů sestaví standardizovaný smluvní dokument — strukturovaně, s odkazem na aktuální znění relevantních zákonných ustanovení. Pro běžné životní a podnikatelské situace, které nevyžadují individuální právní řešení.
...
- Neptá se vás na vaši situaci. Dostanete generický dokument, do kterého opisujete — bez vodítka, co je povinné a co vynechat.
- Datum vydání neznáte. Šablona z minulých let nemusí odpovídat legislativě platné dnes.

**Sloupec 2: Co AI chat nedělá**

- Generuje text, ne dokument. Výsledek závisí na způsobu formulace dotazu a může být pokaždé jiný.
...
- Formulář vás provede systematicky — ptáme se my, ne naopak. Bez toho, abyste museli vědět, co do smlouvy patří.
- Struktura je pevně daná a průběžně aktualizovaná. Výstup je vždy konzistentní.

**Závěrečná věta:**
SmlouvaHned je nástroj pro situace, kde standardizovaný dokumentový postup postačí — a kde improvizace nestačí.
...
SmlouvaHned je určen pro standardní situace. Pro složitější případy — transakce s vysokou hodnotou, mezinárodní prvek, existující spor nebo nestandardní ujednání — doporučujeme konzultaci s advokátem.
...
**Text:**
Vyberte typ dokumentu, vyplňte formulář a stáhněte PDF k závěrečné kontrole a podpisu. Pro standardní situace, které nevyžadují individuální právní řešení.
...
*Produkční verze v3 — připraveno k nasazení.*
