...
const EXPAT_BLOG_ARTICLES: ExpatBlogArticle[] = [
  ...
  contractArticleUa('car_sale', {
    ...
    intro: 'Приватний продаж авто оформлюють договором купівлі-продажу за Цивільним кодексом. Перереєстрацію власника проводять окремо в реєстрі транспортних засобів.',
