...
const SECTIONS_UA: ExpatBlogSection[] = [
  ...
  },
  {
    ...
    bullets: [
      'Шаблон з інternetu → ви редагуєте; SmlouvaHned → PDF із форми',
...
export const EXPAT_BLOG_WHY_SMOLOUVAHNED: ExpatBlogArticle[] = [
  ...
  },
  {
    ...
    ui: {
      ...
      readTime: 'читання',
      tocTitle: 'Зміст',
      relatedHub: 'Усі гіди для інозemціv',
      backToExpats: 'Огляд договорів для інозemціv',
