  ...
  if (locale === 'ua') {
    return withLandingAndPage('employment', locale, {
      ...
      landing: {
        ...
        h1Accent: 'онлайн',
        subtitle:
          'Чеський трудовий договір із формою українською. За бажанням у PDF положення CZ+UA попарно розміщуються в одному документі.',
  ...
  if (locale === 'en') {
    return withLandingAndPage('employment', locale, {
      ...
      landing: {
        ...
        h1Accent: 'online',
        subtitle:
          'Czech employment contract with an English-guided form. Optionally, the PDF pairs the CZ+EN clauses in one document.',
    ...
    landing:
      locale === 'en'
        ? {
            ...
            h1Accent: '(DPP)',
            subtitle: 'Czech DPP with an English-guided form and an optional clause-paired CZ+EN PDF. Max. 300 hours/year.',
        ...
        : {
            ...
            h1Main: 'Договір DPP',
            h1Accent: '',
            subtitle: 'Чеський DPP із формою українською та додатковим PDF із попарними положеннями CZ+UA. Макс. 300 год/рік.',
...
const subleaseUi = (locale: AppLocale) =>
  genericUi(
    ...
    },
    {
      ...
      h1Accent: 'online',
      subtitle: 'Czech sublease with an English-guided form and an optional clause-paired CZ+EN PDF.',
    ...
    },
    {
      ...
      h1Main: 'Піднайм',
      h1Accent: 'онлайн',
      subtitle: 'Чеський договір піднайму з формою українською та додатковим PDF із попарними положеннями CZ+UA.',
...
const carUi = (locale: AppLocale) =>
  genericUi(
    ...
    },
    {
      ...
      h1Accent: 'agreement',
      subtitle: 'Czech vehicle purchase agreement with an English-guided form and an optional clause-paired CZ+EN PDF.',
    ...
    },
    {
      ...
      h1Main: 'Купівля авто',
      h1Accent: '',
      subtitle: 'Чеський договір купівлі-продажу авто з формою українською та додатковим PDF із попарними положеннями CZ+UA.',
...
const poaUi = (locale: AppLocale) =>
  genericUi(
    ...
    },
    {
      ...
      h1Accent: 'online',
      subtitle: 'Czech power of attorney with an English-guided form and an optional clause-paired CZ+EN PDF.',
    ...
    },
    {
      ...
      h1Main: 'Довіреність',
      h1Accent: 'онлайн',
      subtitle: 'Чеська довіреність із формою українською та додатковим PDF із попарними положеннями CZ+UA.',
