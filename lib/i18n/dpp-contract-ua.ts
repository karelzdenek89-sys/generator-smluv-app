  ...
  const sections: ContractSection[] = [
    {
      ...
      body: [
        ...
        DPP_HOURS_LIMIT_UA,
        'Ключові орієнтири: ліміт DPP становить 300 годин за календарний рік у одного роботодавця; стандартне припинення можливе з 15-денним повідомленням; робота може виконуватися також віддалено, якщо це дозволяє характер завдання.',
    ...
    },
    {
      ...
      body: [
        ...
        'До DPP застосовуються правила робочого часу, відпочинку, розкладу змін, перешкод у роботі та доплат у передбаченому законом обсязі. Не застосовуються лише інститути, прямо виключені § 77(2), зокрема переведення, тимчасове відрядження та вихідна допомога.',
        DPP_VACATION_NOTE_UA,
        ...
        'Робота може виконуватися в офісі роботодавця, за погодженим місцем, дистанційно або віддалено, якщо це дозволяє характер завдання та дотримання конфіденційності й безпеки даних.',
        dppToolsClauseUa(d),
      ],
    },
    ...premiumContent,
