...
const COPY = {
  cs: {
    ...
    notice: 'Stažení dokumentu je placené: základní dokument 99 Kč, rozšířený 199 Kč, tematické balíčky 299–599 Kč. Vyplňte údaje a pokračujte k souhrnu: před platbou uvidíte přesnou cenu a vyberete variantu. Bez předplatného.',
  ...
  en: {
    ...
    notice: 'Document download is paid: basic document 99 CZK, extended 199 CZK, thematic packages 299–599 CZK. Complete the form to review the exact price and choose a version before paying. No subscription.',
  ...
  ua: {
    ...
    notice: 'Завантаження документа платне: базовий документ 99 CZK, розширений 199 CZK, тематичні пакети 299–599 CZK. Заповніть форму: перед оплатою ви побачите точну ціну та виберете версію. Без підписки.',
