...
import { CHECKOUT_SCOPE_TEXT, PDF_OUTPUT_TEXT, SERVICE_DISCLAIMER_CZ } from '@/lib/servicePositioning';
      ...
      <div className="premium-page-shell-ref max-w-4xl">
        ...
        <div className="space-y-10 text-sm leading-relaxed">
          <section className="premium-page-card-soft-ref p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs leading-relaxed text-rose-200">{SERVICE_DISCLAIMER_CZ}</p>
              </div>
            </div>
          </section>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p className="mb-3">
              Provozovatelem webu, prodávajícím a poskytovatelem služby je <strong className="text-white">Karel Zdeněk</strong>, IČO 23660295,
            ...
            <p className="mt-3 text-xs text-slate-400">
              Tyto obchodní podmínky upravují práva a povinnosti mezi poskytovatelem služby a zákazníkem při objednávce digitálního obsahu
              prostřednictvím webu SmlouvaHned.cz.
            </p>
          </section>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p className="mb-3">
              Předmětem služby je umožnění zákazníkovi sestavit standardizovaný smluvní dokument na základě údajů vložených do online formuláře.
              {` ${PDF_OUTPUT_TEXT}`}
            </p>
            <p>
              Služba je určena pro běžné a typizované situace, ve kterých se strany shodly na obsahu dokumentu. Poskytovatel neprovádí
              individuální právní posouzení konkrétní situace zákazníka a neposkytuje právní zastoupení.
            </p>
          </section>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p className="mb-3">
              Smlouva mezi poskytovatelem a zákazníkem vzniká odesláním objednávky a úspěšným provedením platby. Zákazník před dokončením
              objednávky vidí vybraný typ dokumentu, zvolenou variantu, cenu a související podmínky.
            </p>
            <p className="mb-3">{CHECKOUT_SCOPE_TEXT}</p>
            <p>
              Zákazník odpovídá za správnost a úplnost údajů vložených do formuláře. Před použitím dokumentu je povinen výstup zkontrolovat,
              zejména identifikační údaje, částky, termíny a další konkrétní podmínky.
            </p>
          </section>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p className="mb-3">
              Platba probíhá prostřednictvím zabezpečené platební brány <strong className="text-white">Stripe</strong>. Platební údaje
              nezpracovává poskytovatel přímo. Po potvrzení platby je zákazníkovi zpřístupněn odkaz ke stažení dokumentu na stránce a může mu
              být zaslán také na e-mail, pokud jej při objednávce zadal.
            </p>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p className="mb-3">
              Výstupem služby je digitální obsah ve formátu PDF. Dokument je zpřístupněn online po úspěšném dokončení platby bez nutnosti
              zakládání uživatelského účtu.
            </p>
            <div className="rounded-2xl border border-white/5 bg-[#0c1426]/60 p-5 text-sm text-slate-300">
              <p>
                <strong className="text-white">Technické požadavky:</strong> běžný webový prohlížeč, funkční internetové připojení a zařízení
                schopné otevřít soubory PDF.
              </p>
              <p className="mt-2">
                <strong className="text-white">Kompatibilita:</strong> dokument je určen pro obvyklé prohlížeče PDF na počítači, tabletu nebo
                mobilním telefonu.
              </p>
              <p className="mt-2">
                <strong className="text-white">Doba dostupnosti odkazu:</strong> 7 dnů u Základního dokumentu, 14 dnů u Rozšířeného dokumentu a
                30 dnů u Kompletního balíčku.
              </p>
            </div>
          </section>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p className="mb-3">
              Zákazník objednává digitální obsah, který je zpřístupněn bezprostředně po zaplacení. Před dokončením objednávky zákazník
              výslovně souhlasí s okamžitým zpřístupněním digitálního obsahu a bere na vědomí, že tím ztrácí právo odstoupit od smlouvy ve
              14denní lhůtě podle § 1837 písm. l) občanského zákoníku.
            </p>
            <p>
              Pokud by k okamžitému zpřístupnění digitálního obsahu nedošlo a podmínky pro zánik práva na odstoupení nebyly splněny, uplatní se
              obecná zákonná pravidla pro smlouvy uzavírané na dálku.
            </p>
          </section>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p className="mb-3">
              Poskytovatel odpovídá za to, že digitální obsah při zpřístupnění odpovídá smlouvě, zejména že je dostupný, čitelný, technicky
              funkční a odpovídá údajům zadaným zákazníkem v rozsahu, v jakém je výstup vytvářen systémem.
            </p>
            <p className="mb-3">
              Reklamaci lze uplatnit zejména tehdy, pokud dokument nelze stáhnout, nelze jej otevřít, zpřístupnění selhalo z technických důvodů
              na straně poskytovatele nebo výstup neodpovídá zadaným údajům v důsledku chyby systému. Tím nejsou dotčena zákonná práva
            ...
            <p className="mb-3">
              ...
              . Uveďte co nejpřesnější popis problému, identifikaci objednávky a případně screenshot nebo jiný podklad. Přijetí reklamace bez
              zbytečného odkladu potvrdíme a vyřídíme ji v zákonné lhůtě.
            </p>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p className="mb-3">
              V případě spotřebitelského sporu, který se nepodaří vyřešit dohodou přímo mezi zákazníkem a poskytovatelem, může spotřebitel podat
              návrh na mimosoudní řešení sporu k subjektu mimosoudního řešení spotřebitelských sporů, kterým je:
            </p>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p>
              Software, šablony a vizuální podoba platformy SmlouvaHned.cz jsou duševním vlastnictvím poskytovatele. Zákazník je oprávněn
              používat zakoupený výstup pro své osobní nebo podnikatelské účely v souladu s povahou dokumentu.
            </p>
          </section>
          ...
          <section className="premium-page-card-ref p-8">
            ...
            <p className="mb-3">
              Tyto obchodní podmínky se řídí právním řádem České republiky. Změny obchodních podmínek nemají vliv na objednávky dokončené před
              jejich účinností.
            </p>
            <p>
