...
export const metadata: Metadata = {
  ...
  description:
    'Smlouva o spolupráci OSVČ nebo firem. Podíl na výnosech, IP práva, mlčenlivost, exit klauzule. Dle § 1746 OZ 2026. Od 249 Kč.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Smlouva o spolupráci OSVČ nebo firem. Podíl na výnosech, IP práva, mlčenlivost, exit. § 1746 OZ. Od 249 Kč.',
