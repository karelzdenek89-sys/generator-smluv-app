  ...
  const handlePayment = async () => {
    try {
      ...
      const res = await fetch('/api/checkout', {
        ...
        body: JSON.stringify({ contractType: 'general_sale', notaryUpsell: form.notaryUpsell, payload: { ...form, contractType: 'general_sale' }, email: form.buyerEmail || form.sellerEmail }),
      });
