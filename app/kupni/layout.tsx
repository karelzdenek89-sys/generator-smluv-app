...
export const metadata: Metadata = {
  ...
  description: 'Formulář pro kupní smlouvu na movitou věc. Zadáte strany, popis věci, cenu a podmínky předání — výsledkem je PDF ke stažení ihned. Od 99 Kč.',
  ...
  openGraph: {
    title: 'Vytvořit kupní smlouvu na věc — formulář | SmlouvaHned',
    description: 'Formulář krok za krokem. Kupní smlouva na movitou věc v PDF ihned. Od 99 Kč.',
    url: `${BASE_URL}/kupni`,
    type: 'website',
  },
};
