          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <section className={cardClass}>
              <label className={`flex items-start gap-4 cursor-pointer rounded-2xl border p-5 transition ${form.notaryUpsell ? 'border-amber-500/70 bg-amber-500/10' : 'border-slate-700/60 bg-[#111c31]'}`}>
                ...
                <div className="flex-1"><div className="font-bold text-white">Prémiový balíček +299 Kč</div><div className="mt-1 text-sm text-slate-400">Vztah k hlavní nájemní smlouvě, smluvní pokuta, datum notářského souhlasu.</div></div>
          ...
          <div className="lg:col-span-5 space-y-5 lg:sticky lg:top-24">
            ...
            <div className={cardClass}>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between"><span className="text-slate-400">Podnájemní smlouva</span><span className="font-bold">299 Kč</span></div>
