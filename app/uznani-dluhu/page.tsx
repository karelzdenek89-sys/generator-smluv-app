            ...
            <section className={cardClass}>
              <label className={`flex items-start gap-4 cursor-pointer rounded-2xl border p-5 transition ${form.notaryUpsell ? 'border-amber-500/70 bg-amber-500/10' : 'border-slate-700/60 bg-[#111c31]'}`}>
                ...
                <div className="flex-1">
                  <div className="font-bold text-white">Prémiový balíček +299 Kč — Exekuční doložka</div>
          ...
          <div className="lg:col-span-5 space-y-5 lg:sticky lg:top-24">
            ...
            <div className={cardClass}>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between"><span className="text-slate-400">Uznání dluhu</span><span className="font-bold">299 Kč</span></div>
                {form.notaryUpsell && <div className="flex justify-between"><span className="text-slate-400">Exekuční doložka</span><span className="text-amber-400 font-bold">+299 Kč</span></div>}
              ...
              <button onClick={handlePayment} disabled={isProcessing || !form.creditorName || !form.debtorName || !form.debtAmount}
