          ...
          <div className="lg:col-span-5 space-y-5 lg:sticky lg:top-24">
            ...
            <div className={cardClass}>
              ...
              <div className="space-y-2 text-sm">
                ...
                {form.notaryUpsell && <div className="flex justify-between"><span className="text-slate-400">Exekuční doložka</span><span className="text-amber-400 font-bold">+249 Kč</span></div>}
