          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-white/5">
              {[
                ...
                ['Minimální odměna', 'Hodinová odměna nesmí být nižší než minimální mzda (v roce 2026: 22 400 Kč/měs. nebo 134,40 Kč/hod. při 40hodinové týdenní pracovní době)'],
              ].map(([oblast, pravidlo]) => (
        ...
        <div className="rounded-2xl border border-white/8 bg-[#0c1426] p-6">
          <ol className="space-y-3">
            {[
              ...
              'Výše odměny — hodinová nebo úkolová sazba (v roce 2026 min. 134,40 Kč/hod. při 40hodinové týdenní pracovní době)',
