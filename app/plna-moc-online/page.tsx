...
export const metadata: Metadata = {
  ...
  description:
    'Plná moc pro zastoupení před úřadem, bankou nebo v obchodní věci. Obecná, jednorázová nebo ověřená verze. Dle § 441 OZ 2026. Od 249 Kč.',
  keywords: [
    'plná moc online',
    'plná moc vzor 2026',
    'plná moc formulář',
  ...
  openGraph: {
    ...
    description: 'Plná moc pro zastoupení před úřadem, bankou nebo v obchodní věci. § 441 OZ. Od 249 Kč.',
    ...
    <main className="min-h-screen bg-[#05080f] text-slate-200">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <div className="text-sm text-slate-500">Od 249 Kč · PDF ke stažení · Dle § 441 OZ</div>
        </div>
        ...
        <section className="rounded-3xl border border-slate-500/20 bg-gradient-to-br from-slate-500/10 to-transparent p-8 text-center">
          ...
          <p className="text-slate-400 text-sm mb-6 max-w-md mx-auto">
            Formulář pro zmocnění — obecná, jednorázová nebo ověřená verze, PDF ke stažení po ověřené platbě.
          </p>
          ...
          <div className="mt-3 text-xs text-slate-600">Od 249 Kč · § 441 OZ · PDF ke stažení</div>
        </section>
