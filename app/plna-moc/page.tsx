            ...
            <section className={cardClass}>
              <label className={`flex items-start gap-4 cursor-pointer rounded-2xl border p-5 transition ${form.notaryUpsell ? 'border-amber-500/70 bg-amber-500/10' : 'border-slate-700/60 bg-[#111c31]'}`}>
                ...
                <div className="flex-1">
                  <div className="font-bold text-white">Profesionální ochrana +200 Kč — Ověřená plná moc</div>
          ...
          <div className="lg:col-span-5 space-y-5 lg:sticky lg:top-24">
            ...
            <div className={cardClass}>
              ...
              <div className="space-y-2 text-sm">
                ...
                {form.notaryUpsell && <div className="flex justify-between"><span className="text-slate-400">Ověřená verze</span><span className="text-amber-400 font-bold">+249 Kč</span></div>}
