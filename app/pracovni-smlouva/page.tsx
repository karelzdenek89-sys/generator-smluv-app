...
export const metadata: Metadata = {
  ...
  description:
    'Vygenerujte pracovní smlouvu se všemi zákonnými náležitostmi dle zákoníku práce 2026. Druh práce, místo výkonu, mzda, zkušební doba. PDF ke stažení od 249 Kč.',
  keywords: [
    ...
    <main className="min-h-screen bg-[#05080f] text-slate-200">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-16">
        ...
        <section className="rounded-3xl border border-amber-500/20 bg-gradient-to-br from-amber-500/10 to-transparent p-8 text-center">
          ...
          <div className="mt-3 text-xs text-slate-600">Od 249 Kč · Zákoník práce 2026 · PDF ke stažení</div>
        </section>
