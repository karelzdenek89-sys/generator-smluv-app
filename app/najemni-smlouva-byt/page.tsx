    ...
    <main className="min-h-screen bg-[#05080f] text-slate-200">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <div className="text-sm text-slate-400">Od 99 Kč · PDF ke stažení · Dle § 2235 OZ</div>
        </div>
        ...
        <section className="rounded-3xl border border-amber-500/20 bg-gradient-to-br from-amber-500/10 to-transparent p-8 text-center">
          ...
          <div className="mt-3 text-xs text-slate-400">Od 99 Kč · § 2235 OZ · PDF ke stažení</div>
        </section>
