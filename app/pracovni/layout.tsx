...
export const metadata: Metadata = {
  ...
  description: 'Formulář pro pracovní smlouvu dle zákoníku práce. Zadáte mzdu, pracovní dobu a zkušební lhůtu — PDF ke stažení ihned. Od 99 Kč.',
  ...
  openGraph: {
    title: 'Vytvořit pracovní smlouvu — formulář online | SmlouvaHned',
    description: 'Formulář krok za krokem. Pracovní smlouva dle zákoníku práce v PDF ihned. Od 99 Kč.',
