...
const situations = [
  {
    title: 'Prodávám auto',
    text: 'Kupní smlouva na vozidlo včetně základních údajů o vozidle, ceně a předání.',
    href: '/auto',
    icon: CarFront,
  },
  {
    title: 'Pronajímám byt',
    text: 'Nájemní smlouva pro běžný nájem bytu nebo domu s přehledně zachycenými podmínkami.',
    href: '/najem',
    icon: Home,
  },
  {
    title: 'Půjčuji peníze',
    text: 'Smlouva o zápůjčce pro situace, kdy potřebujete písemně upravit dluh a splácení.',
    href: '/pujcka',
    icon: HandCoins,
  },
  {
    title: 'Řeším zakázku nebo dílo',
    text: 'Smlouva o dílo pro projekty, práce a výstupy, které mají být předány a převzaty.',
    href: '/smlouva-o-dilo',
    icon: Landmark,
  },
];
...
const pricingTiers = [
  {
    ...
    bullets: [
      ...
      'Základní struktura a standardní náležitosti obvyklé pro daný typ dokumentu',
  ...
  },
  {
    ...
    intro: 'Když potřebujete doplnit důležitá ujednání a snížit riziko běžných sporů nebo nejasností.',
    bullets: [
  ...
  },
  {
    ...
    price: '749 Kč',
    label: 'Pro důkladné dotažení a předání',
    intro: 'Když chcete nejen dokument, ale i vyšší orientaci po nákupu a doprovodné podklady podle varianty.',
    bullets: [
      'Vše z Rozšířeného dokumentu',
      'Checklist a doprovodné podklady podle typu dokumentu',
      'Nejvyšší vnímaná jistota při kontrole, předání a podpisu',
    ],
  },
];
...
function SituationCard({
  ...
  return (
    <Link
      href={href}
      className="group rounded-[1.75rem] border border-slate-200 bg-white/85 p-5 transition duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:bg-white"
    >
      ...
      <div className="rounded-[1.5rem] border border-[#e2d7c4] bg-[#f5efe4] px-6 py-7 text-slate-800 shadow-inner">
        ...
        <div className="space-y-5 text-[15px] leading-7">
          <section>
            ...
            <p className="mt-2">
              Přehledně zachycené identifikační údaje stran podle vyplněných údajů.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Věc, cena, termíny, předání a další klíčová ujednání členěná do jasné struktury.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Dokument je sestaven podle údajů zadaných uživatelem a je určen ke kontrole a podpisu.
            </p>
          </section>
        </div>
      ...
      <main>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
                Vyberete situaci, doplníte údaje do přehledného formuláře a po zaplacení získáte standardizovaný
                dokument v PDF určený ke kontrole a podpisu.
              </p>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                {trustPoints.map(item => (
                  <div key={item} className="rounded-2xl border border-slate-200 bg-white/75 px-4 py-4 text-sm leading-6 text-slate-600 shadow-sm">
                    {item}
                  </div>
                ))}
              </div>
            ...
            <div>
              <PreviewSheet />
              <div className="mt-4 rounded-[1.5rem] border border-amber-200 bg-amber-50 px-4 py-4 text-sm leading-6 text-slate-700">
                SmlouvaHned je online nástroj pro sestavení standardizovaných smluvních dokumentů podle údajů zadaných
                uživatelem. Nejde o individuální právní poradenství ani o poskytování advokátních služeb. U složitých,
                sporných nebo nestandardních situací doporučujeme konzultaci s advokátem.
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="rounded-[2rem] border border-slate-200 bg-white/80 p-6 shadow-[0_20px_50px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:p-8">
              ...
              <ul className="mt-6 space-y-4 text-sm leading-7 text-slate-600">
                ...
                <li>U vyšších variant také doprovodné podklady a lepší připravenost k předání nebo podpisu.</li>
              </ul>
            </div>
            ...
            {[
              {
                ...
                text: 'Zvolíte dokument podle toho, co potřebujete vyřešit. Nemusíte nejprve studovat celý katalog.',
              },
              {
              ...
              },
              {
                ...
                text: 'Po zaplacení je PDF dokument zpřístupněn a připraven ke kontrole a podpisu.',
              },
            ].map((item, index) => (
        ...
        <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-7 text-slate-600">
              Neprodáváme více textu. Vyšší varianty dávají větší jistotu, lepší připravenost k podpisu a doprovodné podklady.
            </p>
          </div>
